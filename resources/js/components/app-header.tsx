...
import { BookKey, BookOpen, Folder, LayoutGrid, Menu, Search, Users } from 'lucide-react';
...
export function AppHeader({ breadcrumbs = [] }: AppHeaderProps) {
    ...
    const mainNavItems: NavItem[] = [...baseNavItems, ...(isAdmin ? adminNavItems : []), ...(isSuperAdmin ? superAdminNavItems : [])];
